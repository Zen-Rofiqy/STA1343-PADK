...
![](images/Screenshot 2023-11-17 113117.png){width="468"}
...
![](images/Screenshot 2023-11-17 100311.png){width="236"}
...
![](images/Screenshot 2023-11-17 121028.png){width="269"}
...
no3 <- data.frame(R = c(hoslem[["statistic"]][[1]], 
                  ...
                  SAS = c(1.6062, 0.9521), 
                  MiniTab = c(0.70, 0.951))
rownames(no3) <- c("khi-kuadrat", "P-Value")
datatable(no3)
```

> Sehingga jawaban yang tepat adalah

![](images/Screenshot 2023-11-17 100615.png){width="314"}
...
Sayangnya saya blm tau caranya menampilkan ini di SAS. 🙏

## Minitab

### Import data

![](images/Screenshot 2023-11-17 111453.png){width="220"}
...
1.  Pada Menu, pilih Stat ➡️ Regression ➡️Binary Logistic Regression ➡️ Fit Binary Logistic Model
    ...
    ![](images/Screenshot 2023-11-17 112119.png){width="579"}

2.  Memasukkan peubah-peubah seperti pada gambar\
    ![](images/Screenshot 2023-11-17 112535.png){width="458"}

3.  Pada bagian Result pastikan tampilannya seperti ini (Bagian **Display of results** dipilih yang **Expanded tables**)\
    ![](images/Screenshot 2023-11-17 112659.png){width="449"}

### Output

![](images/Screenshot 2023-11-17 112922.png)
...
Seperti yang sudah dijelaskan pada No 2. **Nilai odds** pada peubah `Smoking` sebesar $2.161$. Yang berarti kelompok yang memiliki kecenderungan lebih tinggi terkena kanker paru-paru adalah kelompok yang **merokok.** Yakni $2.161$ kali lebih besar dari pada yang tidak **merokok.**
